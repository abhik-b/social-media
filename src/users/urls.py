...
from .views import signupview,loginview,homepage,password_change,send_friend_request,friend_requests,accept_friend_request,delete_friend,all_friends,password_reset
